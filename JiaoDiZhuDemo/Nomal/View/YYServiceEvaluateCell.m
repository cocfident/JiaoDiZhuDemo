...
#import "DYRateView.h"
@interface YYServiceEvaluateCell()
...
@implementation YYServiceEvaluateCell
...
- (void)configSubviews
{
    self.contentView.backgroundColor = RGB(240, 240, 240);
        ...
        _dateLabel.textColor = RGB(149, 152, 154);
...
{
    _serviceModel = model;
    _dateLabel.text = _serviceModel.service_evaluate_date;
    [_rateView setRate:_serviceModel.service_rate];
...
- (void)layoutSubviews
{
    ...
    frame.origin.x = UIWidth - 80;
    frame.size.width = 70;
    _dateLabel.frame = frame;
    
    frame.size.width = 60;
    frame.origin.x = _dateLabel.x - 70;
